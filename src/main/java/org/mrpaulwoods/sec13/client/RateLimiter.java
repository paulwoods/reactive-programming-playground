...
public class RateLimiter {
    ...
    public static final Map<String, Integer> categoryAttempts = Collections.synchronizedMap(new HashMap<>());
    ...
    // make this synchronized to make it thread safe
    ...
    // flux.interval with wait 5 seconds before setting the attempts,
    // so use startWith to immediately set the attempts
